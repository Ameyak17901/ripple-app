            ...
            <div className="text-center space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200 ">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-blue-500 focus:ring-offset-2 whitespace-nowrap"
